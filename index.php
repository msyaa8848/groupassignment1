    ...
    <section id="home" class="hero-bg text-white py-20 md:py-32">
        <div class="container mx-auto px-4 text-center">
            ...
            <div class="flex flex-col md:flex-row justify-center gap-4">
                <a href="#" class="bg-white text-blue-800 font-bold py-3 px-8 rounded-lg hover:bg-gray-100 transition duration-300">Pay Tuition Fees</a>
                <a href="#" class="bg-transparent border-2 border-white text-white font-bold py-3 px-8 rounded-lg hover:bg-white hover:text-blue-800 transition duration-300">Apply for Financial Aid</a>
            </div>
        </div>
    </section>
...
<!-- Dark overlay for better contrast on hover -->
    ...
    <section id="branch-carousel" class="py-16 bg-gray-100">
        <!-- utk limitkan berapa slide page je bole show || ADMIN AKAN HARDCORE --> 

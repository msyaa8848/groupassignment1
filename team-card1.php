...
<div class="container mx-auto px-4 py-12">
    <div class="text-center mb-12">
        <h2 class="text-3xl font-bold text-red-900 mb-2">Our Leadership Team</h2>
        ...
        <div class="swiper-wrapper">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <div class="swiper-slide transition-transform transform hover:-translate-y-2 hover:shadow-xl duration-300 bg-white rounded-xl overflow-hidden shadow-lg">
                    <div class="bg-red-900 h-24"></div>
                    ' . $img . '
                    <div class="p-6 text-center">
                        <h3 class="text-xl font-bold text-red-900 mb-1">' . $row['name'] . '</h3>
